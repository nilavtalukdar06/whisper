...
export default function FeaturesSection() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 place-items-center  relative z-10 py-10 max-w-7xl mx-auto font-mono">
...
const Feature = ({ title, description, icon, index }) => {
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r border-dashed  py-10 relative group/feature dark:border-neutral-800",
        (index === 0 || index === 4) && "lg:border-l dark:border-neutral-800",
        index < 4 && "lg:border-b border-dashed dark:border-neutral-800"
      )}
    >
      {index < 4 && (
